...
const listeningEmitter = `$${receiverSerialNumber},0000002202,615,S64K,1285,52428,24,69,11\r` as const
const listeningReceiver = `$${receiverSerialNumber},0000000600,TBR Sensor,297,15,29,69,6\r` as const
